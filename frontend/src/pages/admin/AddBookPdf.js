...
const AddBookPdf = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formDataToSend.append("book", formData.book); // Append the type
            ...
            if (response.ok) {
                ...
                setFormData({ book: "", name: "", type: "", subject: "", pdfFile: null }); // Reset form
                navigate("/admin/book-pdf"); // Redirect to PDFs page (or any other page)
            } else {
    ...
    return (
        <div className="add-mydata-container">
            ...
            <button className="view-mydata-button" onClick={() => navigate("/admin/bookpdf")}>
                View PDFs
            </button>
        </div>
    );

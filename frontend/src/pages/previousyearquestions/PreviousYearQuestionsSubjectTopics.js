...
function PreviousYearQuestionsSubjectTopics({ subject }) {
    ...
    const fetchPdfs = async () => {
      try {
        ...
        const filteredPdfs = data.filter(pdf => 
          pdf.type === "prev-year-question" && pdf.subject === subject
        );
...
PreviousYearQuestionsSubjectTopics.propTypes = {
  subject: PropTypes.string.isRequired
};

export default PreviousYearQuestionsSubjectTopics;

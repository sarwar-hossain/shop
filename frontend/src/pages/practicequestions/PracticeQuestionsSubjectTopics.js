...
function PracticeQuestionsSubjectTopics({ subject }) {
    ...
    const fetchPdfs = async () => {
      try {
        ...
        const filteredPdfs = data.filter(pdf => 
          pdf.type === "prac-question" && pdf.subject === subject
        );
...
PracticeQuestionsSubjectTopics.propTypes = {
  subject: PropTypes.string.isRequired
};

export default PracticeQuestionsSubjectTopics;

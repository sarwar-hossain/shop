...
import SyllabusPdf from './pages/syllabus/SyllabusPdf';
...
import ClassVideo from './pages/class/class/ClassVideo';
import ClassVideoview from './pages/class/class/ClassVideoView';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/:syllabus/:pdf-viewer/:id" element={<SyllabusPdf />} />
